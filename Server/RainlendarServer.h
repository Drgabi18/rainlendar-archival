...
*/
/*
  $Header: //RAINBOX/cvsroot/Rainlendar/Server/RainlendarServer.h,v 1.2 2003/05/25 15:13:13 Rainy Exp $
...
{
public:
	CRainlendarServer(ssobjects::SockAddr& saBind, CIPFilter* filter);
