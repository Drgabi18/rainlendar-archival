...
*/
/*
  $Header: /home/cvsroot/Rainlendar/Library/Litestep.cpp,v 1.1.1.1 2005/07/10 18:48:07 rainy Exp $
  ...
  Revision 1.8  2004/06/10 15:28:07  rainy
  Fixed time format
...
void InitalizeLitestep(bool dummyLitestep)
{
...
BOOL LSLog(int nLevel, LPCSTR pszModule, LPCSTR pszMessage)
{
	...
	sprintf(buffer, "(%02i:%02i:%02i.%03i) ", (time - startTime) / (1000 * 60* 60), ((time - startTime) / (1000 * 60)) % 60, ((time - startTime) / 1000) % 60, (time - startTime) % 1000);
