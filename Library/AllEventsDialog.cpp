...
*/
/*
  $Header: /home/cvsroot/Rainlendar/Library/AllEventsDialog.cpp,v 1.1.1.1 2005/07/10 18:48:07 rainy Exp $
...
static void ImportEvents(HWND window)
{
	...
	if (GetOpenFileName(&ofn))
	{
		...
		if (i == plugins.size())
		{
			...
			MessageBox(window, CCalendarWindow::c_Language.GetString("AllEventsGUI", 10), "Rainlendar", MB_OK | MB_ICONEXCLAMATION);
		}
	}
}
