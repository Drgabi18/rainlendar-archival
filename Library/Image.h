...
*/
/*
  $Header: /home/cvsroot/Rainlendar/Library/Image.h,v 1.1.1.1 2005/07/10 18:48:07 rainy Exp $

  $Log: Image.h,v $
  Revision 1.1.1.1  2005/07/10 18:48:07  rainy
  no message

  Revision 1.7  2004/12/05 18:31:03  rainy
...
private:
	IPicture* LoadImage(const std::string& filename);
