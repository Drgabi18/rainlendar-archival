...
# Variables
#
Name "Rainlendar 0.19.3"
OutFile "rainlendar-0.19.3.exe"
...
Section $(strStartMenuSec) secStartMenu
  ...
  CreateShortCut  "$SMPROGRAMS\Rainlendar\Skinning.lnk" "$INSTDIR\Skinning.txt" "" "$INSTDIR\Skinning.txt" 0
...
LeaveSettingsLabel:
  ...
  Delete "$INSTDIR\Languages\English.diff"
