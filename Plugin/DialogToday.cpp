...
*/
/*
  $Header: \\\\RAINBOX\\cvsroot/Rainlendar/Plugin/DialogToday.cpp,v 1.3 2002/02/27 18:55:52 rainy Exp $
...
void CDialogToday::UpdateConfig()
{
	...
	CCalendarWindow::c_Config.SetTodayAlign((CRasterizer::ALIGN)align);
