...
# ADD LINK32 Oleacc.lib Wininet.lib shlwapi.lib libpng.lib Msimg32.lib kernel32.lib user32.lib gdi32.lib Advapi32.lib Ws2_32.lib ssobjects.lib comdlg32.lib shell32.lib comctl32.lib Winmm.lib mapi32.lib /nologo /dll /profile /map /debug /machine:I386 /nodefaultlib:"LIBCMT.lib" /out:"Debug/Rainlendar.dll" /libpath:"..\..\..\3rdparty\ssobjects" /libpath:"..\..\..\3rdparty\lpng125\projects\msvc\win32\libpng\lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=Copy                          Debug\Rainlendar.dll                          ..\TestBench\Rainlendar.dll  	Copy                          Debug\Rainlendar.map                          ..\TestBench\ 
# End Special Build Tool
