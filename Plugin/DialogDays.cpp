...
*/
/*
  $Header: \\\\RAINBOX\\cvsroot/Rainlendar/Plugin/DialogDays.cpp,v 1.2 2001/12/23 10:00:18 rainy Exp $
...
void CDialogDays::UpdateConfig()
{
	...
	case 1:
		CCalendarWindow::c_Config.SetDaysAlign(CRasterizer::ALIGN_CENTER);
		break;
	case 2:
		CCalendarWindow::c_Config.SetDaysAlign(CRasterizer::ALIGN_RIGHT);
		break;
	default:
		CCalendarWindow::c_Config.SetDaysAlign(CRasterizer::ALIGN_LEFT);
	}
