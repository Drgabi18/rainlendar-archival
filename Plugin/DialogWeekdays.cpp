...
*/
/*
  $Header: \\\\RAINBOX\\cvsroot/Rainlendar/Plugin/DialogWeekdays.cpp,v 1.2 2001/12/23 10:00:18 rainy Exp $
...
void CDialogWeekdays::UpdateConfig()
{
	...
	case 1:
		CCalendarWindow::c_Config.SetWeekdaysAlign(CRasterizer::ALIGN_CENTER);
		break;
	case 2:
		CCalendarWindow::c_Config.SetWeekdaysAlign(CRasterizer::ALIGN_RIGHT);
		break;
	default:
		CCalendarWindow::c_Config.SetWeekdaysAlign(CRasterizer::ALIGN_LEFT);
	}
