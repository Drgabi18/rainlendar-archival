...
*/
/*
  $Header: /home/cvsroot/Rainlendar/Plugin/EntryItem.h,v 1.1 2004/11/06 13:38:58 rainy Exp $
...
public:
	...
	bool IsReadOnly() { return m_Item->readOnly; }

	bool IsDeleted() { return m_Item->deleted; }
