...
*/
/*
  $Header: /home/cvsroot/Rainlendar/Plugin/RainlendarAPI.h,v 1.4 2004/12/05 18:24:24 rainy Exp $
...
struct RainlendarItem
{
	...
	GUID guid;
	bool deleted;
	bool readOnly;				// Items are not sent for saving
    time_t timeStamp;	
};
...
RAINLENDAR_API void Rainlendar_Refresh();		// Refreshed everything (loades skin & events)
